                ...
                <div class="card-body">
                    ...
                    if (count($listausuarios) > 0) {
                        ...
                        foreach ($listausuarios as $item) {
                          ...
                          </svg></a> | <a href ='excluir_usuario.php?id=$id'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-trash-fill' viewBox='0 0 16 16'>
